...
It is recommended to use maven to compile this project. Download the project and import to your IDE as a maven project. You will need to add [listviewanimations][2] jar to your local maven repository. If you are on a Unix shell, just run the provided `installDependencies.sh` script.
